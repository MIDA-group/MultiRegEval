...
# nohup python train.py --display_id -1 --dataroot ./datasets/eliceiri_cyc_train --name eliceiri_cyc_train_b2a --model cycle_gan --direction BtoA --input_nc 3 --output_nc 1 --serial_batches --load_size 256 --crop_size 256 --batch_size 16 --gpu_ids 1 > out_b2a.file 2>&1 &
...
mkdir datasets/eliceiri_cyc_test/processed
...
cp -r ../Datasets/Eliceiri_test/processed/A/test/ ./datasets/eliceiri_cyc_test/processed/testA
cp -r ../Datasets/Eliceiri_test/processed/B/test/ ./datasets/eliceiri_cyc_test/processed/testB
...
#### processed
mkdir checkpoints/eliceiri_cyc_processed
cp checkpoints/eliceiri_cyc_train/latest_net_* checkpoints/eliceiri_cyc_processed
python test.py --dataroot ./datasets/eliceiri_cyc_test/processed/ --name eliceiri_cyc_processed --model cycle_gan --num_test 99999 --batch_size 1 --preprocess pad --divisor 256 --gpu_ids 2

...
## Train
nohup python train.py --display_id -1 --dataroot ./datasets/eliceiri_train --name eliceiri_p2p_train_a2b --model pix2pix --direction AtoB --input_nc 1 --output_nc 3 --n_epochs 100 --n_epochs_decay 100 --serial_batches --load_size 256 --crop_size 256 --batch_size 64 --gpu_ids 1 > out_a2b.file 2>&1 &
wait
# Training log at ./checkpoints/eliceiri_p2p_train_a2b/loss_log.txt
nohup python train.py --display_id -1 --dataroot ./datasets/eliceiri_train --name eliceiri_p2p_train_b2a --model pix2pix --direction BtoA --input_nc 3 --output_nc 1 --n_epochs 100 --n_epochs_decay 100 --serial_batches --load_size 256 --crop_size 256 --batch_size 64 --gpu_ids 1 > out_b2a.file 2>&1 &
wait
...
nohup python train.py --display_id -1 --dataroot ./datasets/eliceiri_cyc_train --name eliceiri_cyc_train --model cycle_gan --serial_batches --load_size 256 --crop_size 256 --batch_size 1 --gpu_ids 1 > out.file 2>&1 &
...
# ### Test
# # here input&output sizes are fixed to 1
# python test.py --dataroot ./datasets/eliceiri_cyc_train/ --name eliceiri_cyc_train --model cycle_gan --num_test 99999 --batch_size 1 --preprocess pad --divisor 256 --gpu_ids 1

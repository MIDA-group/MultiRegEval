...
for tlevel in {1..4}; do
	...
	python test.py --dataroot ./datasets/balvan_patches_cyc/fold1/tlevel${tlevel}/ --name balvan_cyc_tlevel${tlevel}_fold1 --model cycle_gan --num_test 99999 --batch_size 1 --preprocess pad --divisor 256 --input_nc 1 --output_nc 1 --gpu_ids 1

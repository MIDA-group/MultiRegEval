...
## Train
nohup python train.py --display_id -1 --dataroot ./datasets/balvan_train/fold$1 --name balvan_p2p_train_fold$1_a2b --model pix2pix --direction AtoB --input_nc 1 --output_nc 1 --n_epochs 100 --n_epochs_decay 100 --serial_batches --load_size 256 --crop_size 256 --batch_size 64 --gpu_ids $2 > out_a2b.file 2>&1 &
# Training log at ./checkpoints/balvan_p2p_train_fold$1_a2b/loss_log.txt
wait
nohup python train.py --display_id -1 --dataroot ./datasets/balvan_train/fold$1 --name balvan_p2p_train_fold$1_b2a --model pix2pix --direction BtoA --input_nc 1 --output_nc 1 --n_epochs 100 --n_epochs_decay 100 --serial_batches --load_size 256 --crop_size 256 --batch_size 64 --gpu_ids $2 > out_b2a.file 2>&1 &
wait
...
nohup python train.py --display_id -1 --dataroot ./datasets/balvan_cyc_train/fold$1 --name balvan_cyc_train_fold$1 --model cycle_gan --serial_batches --load_size 256 --crop_size 256 --batch_size 1 --input_nc 1 --output_nc 1 --gpu_ids $2 > out.file 2>&1 &
...
# ### Test
# # here input&output sizes are fixed to 1
# python test.py --dataroot ./datasets/balvan_cyc_train/fold$1/ --name balvan_cyc_train_fold$1 --model cycle_gan --num_test 99999 --batch_size 1 --preprocess pad --divisor 256 --input_nc 1 --output_nc 1 --gpu_ids $2

...
### Train
wait
nohup python train.py --display_id -1 --dataroot ./datasets/zurich_cyc_train/fold$1 --name zurich_cyc_train_fold$1 --model cycle_gan --preprocess mix --crop_size 256 --batch_size 4 --gpu_ids $2 > out.file 2>&1 &

...
tform_type = 'rigid'
assert tform_type in ['dense', 'rigid', 'mix'], "tform_type must be in ['dense', 'rigid', 'mix']"
args.model_name = f'mnist_us_{tform_type}_b2a'
#RIGID = False
...
plot_samples(model, val_generator, cols=10, titles=titles, save=True,
             ...
             save_name=f'{model_name}_trial.png')
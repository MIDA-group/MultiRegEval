...
## Train
nohup python train.py --dataroot ../../pytorch-CycleGAN-and-pix2pix/datasets/balvan_cyc_train/fold2 --batch_size 64 --crop_size 256 --name balvan_drit_train_fold2 --concat 0 --n_ep 1200 --input_dim_a 1 --input_dim_b 1 --gpu 1 > ./outfiles/balvan_fold2.file 2>&1 &

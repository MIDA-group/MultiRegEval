...
## supervised
nohup python train_affine.py --data_root ./datasets/balvan/fold1 --a2b 0 --supervised --model_name balvan_fold1_su_b2a --epochs 1500 --steps_per_epoch 50 --batch_size 64 --gpu 1 > ./logs/balvan_fold1_su_b2a.out 2>&1 &

wait

## unsupervised
nohup python train_affine.py --data_root ./datasets/balvan/fold1 --a2b 0 --model_name balvan_fold1_us_b2a --epochs 1500 --steps_per_epoch 50 --batch_size 64 --gpu 1 > ./logs/balvan_fold1_us_b2a.out 2>&1 &
